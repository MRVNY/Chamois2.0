    ...
    public class Draw2DEditor : Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            for (int i = myTarget.vertices.Count - 1; i >= 0 ; i--)
            {
				...
				var fmh_109_103_638333265233177560 = Quaternion.identity; myTarget.vertices[i] = Handles.FreeMoveHandle(myTarget.vertices[i] + myTarget.transform.position, handleSize, Vector3.zero, Handles.RectangleHandleCap) - myTarget.transform.position;
